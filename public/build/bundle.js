...
var app = (function () {
    ...
    function compareDefined$1(compare = ascending$4) {
      if (compare === ascending$4) return ascendingDefined$1;
    ...
    function thresholdScott(values, min, max) {
      return Math.ceil((max - min) / (3.5 * deviation(values) * Math.pow(count$2(values), -1 / 3)));
    }
    ...
    function rank(values, valueof = ascending$4) {
      ...
      Uint32Array
        .from(V, (_, i) => i)
        .sort(valueof === ascending$4 ? (i, j) => ascendingDefined$1(V[i], V[j]) : compareDefined$1(compareIndex))
        .forEach((j, i) => {
    ...
    function contours() {
      ...
      function contours(values) {
        ...
        if (!Array.isArray(tz)) {
          const e = extent$1(values), ts = tickStep$1(e[0], e[1], tz);
    ...
    function formatLocale$3(locale) {
      var group = locale.grouping === undefined || locale.thousands === undefined ? identity$7 : formatGroup$1(map$1.call(locale.grouping, Number), locale.thousands + ""),
          currencyPrefix = locale.currency === undefined ? "" : locale.currency[0] + "",
          currencySuffix = locale.currency === undefined ? "" : locale.currency[1] + "",
          decimal = locale.decimal === undefined ? "." : locale.decimal + "",
          numerals = locale.numerals === undefined ? identity$7 : formatNumerals$1(map$1.call(locale.numerals, String)),
    ...
    function graticule() {
      ...
      function lines() {
        return range$4(ceil(X0 / DX) * DX, X1, DX).map(X)
            ...
            .concat(range$4(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$1(x % DX) > epsilon$1; }).map(x))
            .concat(range$4(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$1(y % DY) > epsilon$1; }).map(y));
      }
    ...
    var second$2 = newInterval$1(function(date) {
    ...
    var utcSecond = second$2;

    var minute$2 = newInterval$1(function(date) {
    ...
    var timeMinute = minute$2;

    var hour$2 = newInterval$1(function(date) {
    ...
    var month$2 = newInterval$1(function(date) {
      date.setDate(1);
      date.setHours(0, 0, 0, 0);
    }, function(date, step) {
    ...
    function ticker$1(year, month, week, day, hour, minute) {
      ...
      function tickInterval(start, stop, count) {
        ...
        if (i === 0) return millisecond$3.every(Math.max(tickStep(start, stop, count), 1));
    ...
    const [utcTicks$1, utcTickInterval$1] = ticker$1(utcYear$3, utcMonth$3, utcSunday$1, utcDay$3, utcHour$3, utcMinute$3);
    const [timeTicks$1, timeTickInterval$1] = ticker$1(timeYear$1, timeMonth, sunday$1, timeDay$1, timeHour, timeMinute);
    ...
    function formatWeekNumberSunday$1(d, p) {
      return pad$1(sunday$1.count(timeYear$1(d) - 1, d), p, 2);
    }
    ...
    function formatWeekNumberISO$1(d, p) {
      d = dISO$1(d);
      return pad$1(thursday$1.count(timeYear$1(d), d) + (timeYear$1(d).getDay() === 4), p, 2);
    }
    ...
    function formatWeekNumberMonday$1(d, p) {
      return pad$1(monday$1.count(timeYear$1(d) - 1, d), p, 2);
    }
    ...
    function time() {
      return initRange.apply(calendar(timeTicks$1, timeTickInterval$1, timeYear$1, timeMonth, sunday$1, timeDay$1, timeHour, timeMinute, utcSecond, timeFormat$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
    }

    function utcTime() {
      return initRange.apply(calendar(utcTicks$1, utcTickInterval$1, utcYear$3, utcMonth$3, utcSunday$1, utcDay$3, utcHour$3, utcMinute$3, utcSecond, utcFormat$1).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
    }
    ...
    function ticker(year, month, week, day, hour, minute) {
      ...
      function tickInterval(start, stop, count) {
        ...
        if (i === tickIntervals.length) return year.every(tickStep$2(start / durationYear, stop / durationYear, count));
        if (i === 0) return millisecond$1.every(Math.max(tickStep$2(start, stop, count), 1));
        const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
        return t.every(step);
      }
    ...
    const [timeTicks, timeTickInterval] = ticker(timeYear, month$1, sunday, timeDay, hour$1, minute$1);
    ...
    /* src/Results.svelte generated by Svelte v3.46.3 */
    ...
    // (1:0) <script>  import * as d3 from 'd3'   let promise = loadData();  let participantVis = {"constraintLearner": [],       "constraintSolver": [],       "granularLearner": [],}
    function create_catch_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>  import * as d3 from 'd3'   let promise = loadData();  let participantVis = {\\\"constraintLearner\\\": [],       \\\"constraintSolver\\\": [],       \\\"granularLearner\\\": [],}",
    		ctx
    	});
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			h30 = element("h3");
    			h30.textContent = "Granular Learner";
    			t1 = space();
    			...
    			div1 = element("div");
    			h31 = element("h3");
    			h31.textContent = "Constraint Learners";
    			t4 = space();
    			...
    			div2 = element("div");
    			h32 = element("h3");
    			h32.textContent = "Constraint Solver";
    			t7 = space();
    			...
    			add_location(h30, file$3, 73, 3, 1931);
    			attr_dev(div0, "id", "granular");
    			add_location(div0, file$3, 72, 2, 1908);
    			add_location(h31, file$3, 85, 3, 2224);
    			attr_dev(div1, "id", "learner");
    			add_location(div1, file$3, 84, 2, 2202);
    			add_location(h32, file$3, 97, 3, 2518);
    			attr_dev(div2, "id", "solver");
    			add_location(div2, file$3, 96, 2, 2497);
    		},
    ...
    function create_each_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "id", "granularvis" + /*i*/ ctx[6] + /*j*/ ctx[9]);
    			attr_dev(div0, "class", "svelte-1bk5tm2");
    			add_location(div0, file$3, 78, 7, 2108);
    			attr_dev(div1, "class", "vegaContainer");
    			add_location(div1, file$3, 77, 6, 2073);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(77:5) {#each Array(5) as vega, j}",
    		ctx
    	});
    ...
    // (75:3) {#each Array(6) as participant, i}
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "participantContainer svelte-1bk5tm2");
    			add_location(div, file$3, 75, 4, 1999);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:3) {#each Array(6) as participant, i}",
    		ctx
    	});
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "id", "learnervis" + /*i*/ ctx[6] + /*j*/ ctx[9]);
    			attr_dev(div0, "class", "svelte-1bk5tm2");
    			add_location(div0, file$3, 90, 7, 2404);
    			attr_dev(div1, "class", "vegaContainer");
    			add_location(div1, file$3, 89, 6, 2369);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(89:5) {#each Array(5) as vega, j}",
    		ctx
    	});
    ...
    // (87:3) {#each Array(6) as participant, i}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "participantContainer svelte-1bk5tm2");
    			add_location(div, file$3, 87, 4, 2295);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(87:3) {#each Array(6) as participant, i}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "id", "solvervis" + /*i*/ ctx[6] + /*j*/ ctx[9]);
    			attr_dev(div0, "class", "svelte-1bk5tm2");
    			add_location(div0, file$3, 102, 7, 2696);
    			attr_dev(div1, "class", "vegaContainer");
    			add_location(div1, file$3, 101, 6, 2661);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(101:5) {#each Array(5) as vega, j}",
    		ctx
    	});
    ...
    // (99:3) {#each Array(6) as participant, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "participantContainer svelte-1bk5tm2");
    			add_location(div, file$3, 99, 4, 2587);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(99:3) {#each Array(6) as participant, i}",
    		ctx
    	});
    ...
    // (70:17)    <p>...loading</p>  {:then splitData}
    function create_pending_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 70, 2, 1869);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(70:17)    <p>...loading</p>  {:then splitData}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			info.block.c();
    			attr_dev(div, "id", "overall");
    			attr_dev(div, "class", "svelte-1bk5tm2");
    			add_location(div, file$3, 68, 0, 1830);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	async function loadData() {
    		const dataset = await json(`allPinned.json`);
    		...
    		$$invalidate(1, participantVis = splitData);
    	...
    	$$self.$capture_state = () => ({ d3, promise, participantVis, loadData });

    	$$self.$inject_state = $$props => {
    		if ('promise' in $$props) $$invalidate(0, promise = $$props.promise);
    		if ('participantVis' in $$props) $$invalidate(1, participantVis = $$props.participantVis);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*participantVis*/ 2) {
    ...
    /* src/UMAP.svelte generated by Svelte v3.46.3 */
    const file$2 = "src/UMAP.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$2, 66, 0, 1707);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	var svg = select("#umap").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    	// Add X axis
    	var x = linear().domain(extent$2(dataset, d => d[1][0])).range([width, 0]);

    	svg.append("g").attr("class", "axisBottom").attr("transform", "translate(0," + height + ")").call(axisBottom(x).ticks(3));
    	svg.append("g").attr("class", "axisTop").call(axisTop(x).ticks(0));

    	// Add Y axis
    	var y = linear().domain(extent$2(dataset, d => d[1][1])).range([height, 0]);

    	svg.append("g").call(axisLeft(y).ticks(3));
    	svg.append("g").attr("transform", `translate(${width}, 0)`).call(axisRight(y).ticks(0));

    	// Add dots
    	svg.append('g').selectAll("dot").data(dataset).enter().append("circle").attr("cx", function (d) {
    		return x(d[1][0]);
    	}).attr("cy", function (d) {
    		return y(d[1][1]);
    	...
    	}).attr("cursor", "pointer").on('mouseover', function (d, i) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<UMAP> was created with unknown prop '${key}'`);
    	});
    ...
    class UMAP extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get dataset() {
    		throw new Error("<UMAP>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set dataset(value) {
    		throw new Error("<UMAP>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/ResultsUMAP.svelte generated by Svelte v3.46.3 */
    const file$1 = "src/ResultsUMAP.svelte";

    // (1:0) <script>  import * as d3 from 'd3'  import UMAP from "./UMAP.svelte"   let promise = loadData();   async function loadData() {   const dataset = await d3.json(`umap_coords.json`)    let dataset_by_participant = []    let count = 0    let participant = []    while (count < dataset.length) {    participant.push(dataset[count])     count++     if (count % 5 == 0) {     dataset_by_participant.push(participant)     participant = []    }
    ...
    function create_then_block(ctx) {
    	...
    	umap = new UMAP({
    			props: { dataset: /*data*/ ctx[2][0] },
    			$$inline: true
    		});

    	const block = {
    		c: function create() {
    			create_component(umap.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(umap, target, anchor);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(umap.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(umap.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(umap, detaching);
    		}
    	};
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "...loading";
    			add_location(p, file$1, 35, 2, 558);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(35:17)    <p>...loading</p>  {:then data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			info.block.c();
    			attr_dev(div, "id", "overall");
    			add_location(div, file$1, 33, 0, 519);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ResultsUMAP', slots, []);
    	let promise = loadData();

    	async function loadData() {
    		const dataset = await json(`umap_coords.json`);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ResultsUMAP> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ d3, UMAP, promise, loadData });
    ...
    class ResultsUMAP extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	let resultsumap;
    	let current;
    	resultsumap = new ResultsUMAP({ $$inline: true });

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(resultsumap.$$.fragment);
    			attr_dev(div, "id", "main");
    			set_style(div, "padding", "'20px'");
    			attr_dev(div, "class", "svelte-1dzpmaa");
    			add_location(div, file, 13, 0, 459);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(resultsumap, div, null);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(resultsumap.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(resultsumap.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(resultsumap);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ d3, Results, ResultsUMAP, versionChoice });

    	$$self.$inject_state = $$props => {
    		if ('versionChoice' in $$props) versionChoice = $$props.versionChoice;
    	};
